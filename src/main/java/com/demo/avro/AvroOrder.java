...
public class AvroOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -796757086862468201L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroOrder\",\"namespace\":\"com.demo.avro\",\"fields\":[{\"name\":\"customerName\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public AvroOrder(java.lang.CharSequence customerName, java.lang.CharSequence product, java.lang.Integer quantity) {
   ...
   */
  public static com.demo.avro.AvroOrder.Builder newBuilder() {
    return new com.demo.avro.AvroOrder.Builder();
  }
   ...
   * @return A new AvroOrder RecordBuilder
   */
  public static com.demo.avro.AvroOrder.Builder newBuilder(com.demo.avro.AvroOrder.Builder other) {
    if (other == null) {
      return new com.demo.avro.AvroOrder.Builder();
    } else {
      return new com.demo.avro.AvroOrder.Builder(other);
    }
  }
   ...
   * @return A new AvroOrder RecordBuilder
   */
  public static com.demo.avro.AvroOrder.Builder newBuilder(com.demo.avro.AvroOrder other) {
    if (other == null) {
      return new com.demo.avro.AvroOrder.Builder();
    } else {
      return new com.demo.avro.AvroOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.demo.avro.AvroOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.demo.avro.AvroOrder other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.customerName)) {
        this.customerName = data().deepCopy(fields()[0].schema(), other.customerName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.AvroOrder.Builder setCustomerName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.AvroOrder.Builder clearCustomerName() {
      customerName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.AvroOrder.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.AvroOrder.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.AvroOrder.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.AvroOrder.Builder clearQuantity() {
